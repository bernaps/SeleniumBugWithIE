 ...
 * @author bguillot
 */
public class ShowBugFirefox {

    public void runit() throws MalformedURLException {
        // IE Remote Web driver

        URL wdLocation = new URL("http://127.0.0.1:5555");
        ...
        cap.setCapability("marionette", true); // Use Marionette
//        cap.setCapability("marionette", false); // do not.
    ...
    public static void main(String[] args) throws MalformedURLException {
        ShowBugFirefox showBug = new ShowBugFirefox();
        showBug.runit();
    }
}
